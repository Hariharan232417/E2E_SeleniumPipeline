...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://"+ConfigurationManager.configuration().gridUrl()+":"+ConfigurationManager.configuration().gridPort()+"/wd/hub"), options));
		...
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://"+ConfigurationManager.configuration().gridUrl()+":"+ConfigurationManager.configuration().gridPort()+"/wd/hub"), firefoxOptions));
			//remoteWebdriver.set(new ChromeDriver(firefoxOptions));
